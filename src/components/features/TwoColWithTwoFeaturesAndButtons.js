...
export default ({
  ...
  heading = (
    <>
      We have the most <span tw="text-primary-500">professional</span> developers team.
    </>
  ),
  description = "All of our teammates have bachelor's degrees in computer science at the university, so our expertise is based on knowledge in-depth in computer science. Moreover, we mastered our own technical skill individually in development for mobile and web before joining the team, thus we can handle any project, which requires special skill.",
